      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _AreaTile(title: 'Allenamento', subtitle: 'Mese 1 — completato al 80%', icon: Icons.fitness_center),
            _AreaTile(title: 'Alimentazione', subtitle: 'Mese 1 — completato al 60%', icon: Icons.restaurant),
            _AreaTile(title: 'Benessere', subtitle: 'Mese 1 — completato al 45%', icon: Icons.spa),
            _AreaTile(title: 'Integrazione', subtitle: 'Fase 1 — completato al 30%', icon: Icons.water_drop),
