...
void main() {
  IntegrazionePhase phase(String id) =>
      IntegrazionePhase(id: id, title: 'Fase $id', sort: int.parse(id), products: const []);
  ...
  group('IntegrazioneData', () {
    ...
    test('when not started, phase 0 is active and later phases are locked', () {
      final data = IntegrazioneData(phases: [phase('1'), phase('2'), phase('3')]);
