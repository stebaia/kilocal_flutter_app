# Overview (legacy shop)

> ⚠️ **LEGACY — sistema diverso.** Lo **shop e-commerce Nuxt** (`kilocal-shop-fe`), dal PDF
> `raw/KILOCAL DOCUMENTAZIONE TECNICA.pdf`. **Non è l'app mobile** — quella usa Directus +
> Bearer JWT, vedi [[overview]]. Riferimento storico.
